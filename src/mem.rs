...
#[cfg(not(feature = "const_generics"))]
impl_memory!(u8, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
#[cfg(not(feature = "const_generics"))]
impl_memory!(u16, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
#[cfg(not(feature = "const_generics"))]
impl_memory!(u32, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
#[cfg(not(feature = "const_generics"))]
impl_memory!(u64, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
#[cfg(not(feature = "const_generics"))]
impl_memory!(u128, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
#[cfg(not(feature = "const_generics"))]
impl_memory!(usize, 0, 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192);
